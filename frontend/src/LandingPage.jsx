  ...
  return (
    ...
    >
      ...
      <svg
        ...
        fill="none"
      >
        {/* Background geographic outlines */}
        <path d="M10 30 Q 60 15, 110 40 T 210 25" stroke="rgba(10,10,10,0.04)" strokeWidth="3" fill="none" />
        <path d="M20 100 Q 100 85, 150 110 T 230 95" stroke="rgba(10,10,10,0.04)" strokeWidth="2.5" fill="none" />

        {/* Roads network */}
        <path d="M50 45 L 100 65 L 140 55 L 190 95" stroke="rgba(10,10,10,0.08)" strokeWidth="1.5" />
        <path d="M100 65 L 90 115" stroke="rgba(10,10,10,0.05)" strokeWidth="1" />

        {/* Highlighted active route line with dash draw animation */}
        <path
          d="M50 45 L 100 65 L 140 55 L 190 95"
        ...
        {/* Origin pin */}
        <circle cx="50" cy="45" r="4" fill="#ffbf3d" />
        <circle cx="50" cy="45" r="7" stroke="#ffbf3d" strokeWidth="1" opacity="0.4" className="lp-ping-anim" />

        {/* Intermediate Stop pin */}
        <circle cx="100" cy="65" r="3" fill="#4fd0a0" />

        {/* Rest Break Node */}
        <circle cx="140" cy="55" r="3" fill="#9d7cff" />

        {/* Destination pin */}
        <circle cx="190" cy="95" r="4" fill="#ff6d5f" />
        <circle cx="190" cy="95" r="7" stroke="#ff6d5f" strokeWidth="1" opacity="0.4" className="lp-ping-anim" />
      </svg>
      ...
      <div style={{
        ...
        borderRadius: "4px", fontSize: "0.5rem", color: "rgba(10,10,10,0.7)",
        border: "1px solid rgba(10,10,10,0.08)", display: "flex", gap: "4px",
        boxShadow: "0 2px 6px rgba(0,0,0,0.04)"
      }}>
        <span style={{ color: "#76a8ff", fontWeight: "bold" }}>I-80 W</span>
